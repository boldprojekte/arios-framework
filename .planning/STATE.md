...
- ideate.md Mode-Aware Routing section defines Feature vs Project paths (11-05)
- Feature-Mode ideation skips ROADMAP.md, creates feature-{name}/ folder (11-05)
- Workflow step 3 reads mode from config.json, step 8 branches on mode (11-05)
