...
<task type="auto">
  ...
  **Important:** orchestrate.md is a documentation file containing instructions for Claude.
  Claude follows these instructions when running /execute. This is NOT executable code —
  Claude reads this document and implements the described behavior during execution.
  ...
  **Key principle:** Agent verifies what was completed before proceeding.
  ...
  Note: Claude will implement the file/git detection logic when following orchestrate.md during execution.
  No separate utility function is needed — Claude has access to file system and git commands.
  </action>
